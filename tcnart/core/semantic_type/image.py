...
class ImageContentConfig:
    compression_type: ImageCompressionTypes | None = None
    format_type: ImageFormatTypes | None = None
    ...
    def new(cls, value: uint64) -> "ImageContentConfig":
        ...
        cfg.format_type = ImageFormatTypes.from_u8(
    ...
    # Getters
    def get_compression_type(self) -> ImageCompressionTypes | None:
        return self.compression_type

    def get_format_type(self) -> ImageFormatTypes | None:
    ...
    # Setters
    def set_compression_type(self, compression_type: ImageCompressionTypes) -> None:
        self.compression_type = compression_type

    def set_format_type(self, format_type: ImageFormatTypes) -> None:
