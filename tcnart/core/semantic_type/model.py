...
class constants:
    ...
    SCALAR_TYPE_MASK: int = int(0x3F << SCALAR_TYPE_OFFSET)
    CARDINALITY_TYPE_MASK: int = int(0x03 << CARDINALITY_TYPE_OFFSET)
    CONTAINER_TYPE_MASK: int = int(0x3F << CONTAINER_TYPE_OFFSET)
    MEMORY_REPRESENTATION_TYPE_MASK: int = int(0x03 << MEMORY_REPRESENTATION_TYPE_OFFSET)
    ...
    BASE_TYPE_MASK: int = int(0xFFFF)
    SEMANTIC_TYPE_MASK: int = int((~BASE_TYPE_MASK) & 0xFFFFFFFFFFFFFFFF)
    CONTENT_TYPE_MASK: int = int(0xFF << CONTENT_TYPE_OFFSET)
    COMPRESSION_TYPE_MASK: int = int(0xFF << COMPRESSION_TYPE_OFFSET)
    FORMAT_TYPE_MASK: int = int(0xFF << FORMAT_TYPE_OFFSET)
    CUSTOM1_TYPE_MASK: int = int(0xFF << CUSTOM1_TYPE_OFFSET)
    CUSTOM2_TYPE_MASK: int = int(0xFF << CUSTOM2_TYPE_OFFSET)
    CUSTOM_MASK_TYPE_MASK: int = int(0xFF << CUSTOM_MASK_TYPE_OFFSET)
